...
recorder Node -file ProbetasB1disp2.out -time -closeOnWrite -node $nodocentral -dof 2 disp
recorder Node -file ProbetasB1reac2.out -time -closeOnWrite -node 1 [expr 1+$nele/15] [expr $nnodos-$nele/15] $nnodos -dof 2 reaction
...
constraints Plain
test FixedNumIter 12 1
#test NormDispIncr 1.e-7 10 1
#algorithm Newton
#algorithm BFGS
algorithm ModifiedNewton -initial
#algorithm KrylovNewton
