...
recorder Node -file ProbetasDP1disp2.out -time -closeOnWrite -node $nodocentral -dof 2 disp
recorder Node -file ProbetasDP1reac2.out -time -closeOnWrite -node 1 [expr 1+$nele/15] [expr $nnodos-$nele/15] $nnodos -dof 2 reaction
...
set stepanalisis [expr -45.0/$nanalize]
