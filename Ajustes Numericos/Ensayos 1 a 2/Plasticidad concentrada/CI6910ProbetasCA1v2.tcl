...
recorder Node -file ProbetasCA1disp.out -time -closeOnWrite -node $nodocentral -dof 2 disp
recorder Node -file ProbetasCA1reac.out -time -closeOnWrite -node 1 [expr 1+$nele/15] [expr $nnodos-$nele/15] $nnodos -dof 2 reaction
...
#system SparseGEN
#system UmfPack 
integrator DisplacementControl  $nodocentral  2 -0.03
#integrator DisplacementControl 5 3 -0.0001; # displacement control algorithm seking constant increment of 0.1 at node 1 at 2'nd dof.
#analysis Transient 
analysis Static
