...
recorder Node -file ProbetasCA2disp.out -time -closeOnWrite -node $nodocentral -dof 2 disp
recorder Node -file ProbetasCA2reac.out -time -closeOnWrite -node 1 [expr 1+$nele/15] [expr $nnodos-$nele/15] $nnodos -dof 2 reaction
