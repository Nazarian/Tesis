...
recorder Node -file EN14651FAdispFA.out -time -closeOnWrite -node $nodocentral -dof 2 disp
recorder Node -file EN14651FAreacFA.out -time -closeOnWrite -node 1 $nnodos [expr $nnodos+1] [expr $nnodos+$nnodos] -dof 2 reaction
