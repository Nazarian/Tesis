...
recorder Node -file EN14651FAdisp.out -time -node $nodocentral -dof 2 disp
recorder Node -file EN14651FAreac.out -time -node 1 $nnodos [expr $nnodos+1] [expr $nnodos+$nnodos] -dof 2 reaction
...
constraints Plain
test NormDispIncr 1.e-12 300 1
algorithm Newton
#algorithm BFGS
